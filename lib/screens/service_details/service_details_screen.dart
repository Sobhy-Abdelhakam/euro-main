...
class _ServiceDetailsScreenState extends State<ServiceDetailsScreen> {
  late PhloxAnimationsController controller;
        ...
        if (state is ServiceDetailsLoaded) {
          if (state.services.isNotEmpty) {
            ...
            return Scaffold(
              ...
              body: data.serviceList != null && data.serviceList!.isNotEmpty
                  ? AnimationLimiter(
                              ...
                              child: ScaleAnimation(
                                child: InkWell(
                                  onTap: () {
                                    ...
                                    BlocProvider.of<ServiceDetailsCubit>(
                                            context)
                                        .getServices();
                                    Navigator.push(
                                      context,
